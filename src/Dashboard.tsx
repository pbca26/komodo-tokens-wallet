...
const Dashboard: React.FC<DashboardProps> = props => {
  ...
  const syncData = async () => {
    ...
    const tokenList = chains[chain].explorerApiVersion && chains[chain].explorerApiVersion === 2 ? await Blockchain[props.isDemo ? 'mock' : 'default'].tokenList(cctxids) : await Blockchain[props.isDemo ? 'mock' : 'default'].tokenList();

...
import {CancelAskTokenModalProps} from './types';

const CancelAskTokenModal: React.FC<CancelAskTokenModalProps> = props => {
  ...
  const cancelSellTokenOrder = async () => {

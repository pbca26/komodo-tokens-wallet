...
import {FillBidTokenModalProps} from './types';

const FillBidTokenModal: React.FC<FillBidTokenModalProps> = props => {
    ...
    if (Number(state.amount) > order.askamount ||
      ...
      try {
        ...
        inputsData = {
          ...
          normalUtxos: await Blockchain.createCCTx(toSats(order.price * state.amount + 0.00001), address.pubkey),
        };
